...
namespace Kippt
{
    public partial class KipptNotification
    {
        ...
        public static KipptNotificationCollection GetNotifications(KipptClient client)
        {
            return client.Api<KipptNotificationCollection>(ApiCommand.Notifications, HttpMethod.Get);
        }
        ...
        public static KipptNotificationCollection GetNotifications(KipptClient client, int limit)
        {
            return GetNotifications(client, limit, 0);
        }
